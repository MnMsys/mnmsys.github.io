      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-white text-lg font-bold">MnMs.io</h3>
            <p className="text-sm">
              Secure DevOps platform for monitoring and managing production machines with zero-trust security.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/devopsteams" className="hover:text-blue-400 transition-colors">DevOps Teams</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <a href="mailto:contact@mnms.io" className="hover:text-blue-400 transition-colors">contact@mnms.io</a>
              </li>
              <li className="flex items-center space-x-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">© 2024 MnMs.io. All rights reserved.</p>
